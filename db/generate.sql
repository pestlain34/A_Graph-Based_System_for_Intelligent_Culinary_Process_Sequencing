...
(
    ...
    image_filename  TEXT                NOT NULL DEFAULT 'photo_2025-12-20_01-36-59.jpg'
);
...
INSERT INTO recipe (title, description, recipe_type_id, difficulty, user_id, status_of_recipe, image, image_mime,
                    image_filename)
VALUES ('Паста с соусом', 'Вкусная паста с соусом и сыром', 1, 'средняя', 1, 'not_publicated', 'images (12).jpg', 'png', 'images (12).jpg');
