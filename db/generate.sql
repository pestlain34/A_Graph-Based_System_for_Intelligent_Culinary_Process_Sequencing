...
VALUES ('Молочные продукты', 'Все продукты, произведенные из молока'),
       ('Овощи', 'Свежие овощи'),
...
VALUES ('основные блюда', 'Блюда, которые подаются после закусок и перед десертом'),
       ('салаты',
        'Холодное блюдо, состоящее из одного вида или смеси разных видов сочетающихся между собой нарезанных продуктов в заправке'),
       ('десерты',
        'Завершающее блюдо стола, предназначенное для получения приятных вкусовых ощущений в конце обеда или ужина, обычно — сладкие деликатесы.');
-- Ингредиенты
...
-- Рецепты
INSERT INTO recipe (title, description, recipe_type_id, difficulty, user_id, status_of_recipe, image, image_mime,
                    image_filename)
VALUES ('Паста с соусом', 'Вкусная паста с соусом и сыром', 1, 'средняя', 1, 'not_publicated', '', 'png', 'test');
